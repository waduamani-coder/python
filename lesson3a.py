...
# comparison: They are used to compare two or more statements and they usually return a boolean answer
...
print("is number1 greater than or equal tonumber2?" , number1>= number2)
